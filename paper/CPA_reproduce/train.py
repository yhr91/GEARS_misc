...
def parse_arguments():
    ...
    parser.add_argument('--dataset', type=str, default="jost2020_hvg")
    ...
    parser.add_argument('--save_dir', type=str,
                        default='./TFcombosin5k_nocombo_somesingle_worstde/')
    # number of trials when executing compert.sweep
    parser.add_argument('--sweep_seeds', type=int, default=200)
    parser.add_argument('--emb', type=str, default='one_hot', choices = ['one_hot', 'kg'])
